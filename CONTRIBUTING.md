...
1. Go to your project's page on PyPI: `https://pypi.org/manage/project/mdformat_slw/settings/publishing/`
...
1. Add a new Trusted Publisher with these settings:
    - **PyPI Project Name**: `mdformat_slw`
    - **Owner**: `kyleking`
    - **Repository name**: `mdformat-slw`
...
Use `commitizen` to automatically bump versions (in `pyproject.toml` and `mdformat_slw/__init__.py`) and create a commit with tag:
